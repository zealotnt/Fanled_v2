...
__attribute__((weak)) DSTATUS FATFS_SD_SDIO_disk_initialize(void) {return RES_ERROR;}
__attribute__((weak)) DSTATUS FATFS_SD_disk_initialize(void) {return RES_ERROR;}
__attribute__((weak)) DSTATUS FATFS_USB_disk_initialize(void) {return RES_ERROR;}
__attribute__((weak)) DSTATUS FATFS_SDRAM_disk_initialize(void) {return RES_ERROR;}
__attribute__((weak)) DSTATUS FATFS_SPI_FLASH_disk_initialize(void) {return RES_ERROR;}

__attribute__((weak)) DSTATUS FATFS_SD_SDIO_disk_status(void) {return RES_ERROR;}
__attribute__((weak)) DSTATUS FATFS_SD_disk_status(void) {return RES_ERROR;}
__attribute__((weak)) DSTATUS FATFS_USB_disk_status(void) {return RES_ERROR;}
__attribute__((weak)) DSTATUS FATFS_SDRAM_disk_status(void) {return RES_ERROR;}
__attribute__((weak)) DSTATUS FATFS_SPI_FLASH_disk_status(void) {return RES_ERROR;}

__attribute__((weak)) DRESULT FATFS_SD_SDIO_disk_ioctl(BYTE cmd, void *buff) {return (DRESULT)STA_NOINIT;}
__attribute__((weak)) DRESULT FATFS_SD_disk_ioctl(BYTE cmd, void *buff) {return (DRESULT)STA_NOINIT;}
__attribute__((weak)) DRESULT FATFS_USB_disk_ioctl(BYTE cmd, void *buff) {return (DRESULT)STA_NOINIT;}
__attribute__((weak)) DRESULT FATFS_SDRAM_disk_ioctl(BYTE cmd, void *buff) {return (DRESULT)STA_NOINIT;}
__attribute__((weak)) DRESULT FATFS_SPI_FLASH_disk_ioctl(BYTE cmd, void *buff) {return (DRESULT)STA_NOINIT;}

__attribute__((weak)) DRESULT FATFS_SD_SDIO_disk_read(BYTE *buff, DWORD sector, UINT count) {return (DRESULT)STA_NOINIT;}
__attribute__((weak)) DRESULT FATFS_SD_disk_read(BYTE *buff, DWORD sector, UINT count) {return (DRESULT)STA_NOINIT;}
__attribute__((weak)) DRESULT FATFS_USB_disk_read(BYTE *buff, DWORD sector, UINT count) {return (DRESULT)STA_NOINIT;}
__attribute__((weak)) DRESULT FATFS_SDRAM_disk_read(BYTE *buff, DWORD sector, UINT count) {return (DRESULT)STA_NOINIT;}
__attribute__((weak)) DRESULT FATFS_SPI_FLASH_disk_read(BYTE *buff, DWORD sector, UINT count) {return (DRESULT)STA_NOINIT;}

__attribute__((weak)) DRESULT FATFS_SD_SDIO_disk_write(const BYTE *buff, DWORD sector, UINT count) {return (DRESULT)STA_NOINIT;}
__attribute__((weak)) DRESULT FATFS_SD_disk_write(const BYTE *buff, DWORD sector, UINT count) {return (DRESULT)STA_NOINIT;}
__attribute__((weak)) DRESULT FATFS_USB_disk_write(const BYTE *buff, DWORD sector, UINT count) {return (DRESULT)STA_NOINIT;}
__attribute__((weak)) DRESULT FATFS_SDRAM_disk_write(const BYTE *buff, DWORD sector, UINT count) {return (DRESULT)STA_NOINIT;}
__attribute__((weak)) DRESULT FATFS_SPI_FLASH_disk_write(const BYTE *buff, DWORD sector, UINT count) {return (DRESULT)STA_NOINIT;}
