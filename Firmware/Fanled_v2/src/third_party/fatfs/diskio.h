 ...
 */
typedef enum {
	FATFS_Driver_USER1 = 0x00, /*!< Use USER1: when mounting and other stuff to access to this driver. USER1 is a logical string name of your drive */
	FATFS_Driver_USER2 = 0x01  /*!< User USER2: when mounting and other stuff to access to this driver. USER2 is a logical string name of your drive */
} FATFS_Driver_t;
